...
from ExplanationEvaluation.tasks.replication_table import fid_edit_distance,fid_edit_distance_ab
...
fid_edit_distance_ab(config.args.explainer, extension,
                            run_qual=False,results_store=False,extend=False,key=(0,5))
