...
from ExplanationEvaluation.tasks.replication_table import experiment_new_fid_ab_editdistance_unrealative,replication_sp


datasets = [ 'bashapes']  # 'treecycles', 'ba2motifs', 'mutag' 'bashapes','bacommunity',
for _dataset in datasets:
    ...
    experiment_new_fid_ab_editdistance_unrealative(config.args.explainer, k_p=1, k_m=1, seeds_num=1)
