...
from ExplanationEvaluation.tasks.replication_table import experiments_weights_ori_fids,replication_sp
...
# key -> (remove, add)
path = r''
(auc, auc_std), inf_time = experiments_weights_ori_fids(config.args.explainer,path=path)
