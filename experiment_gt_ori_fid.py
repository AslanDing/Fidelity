...
from ExplanationEvaluation.tasks.replication_table import experiments_gt_ori_fids,replication_sp
...
# this py is to calculate original fid+ fid- and fid\Delta of ground truth

(auc, auc_std), inf_time = experiments_gt_ori_fids(config.args.explainer, extension,results_store=False)
