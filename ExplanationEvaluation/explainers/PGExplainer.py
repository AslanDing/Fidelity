...
class PGExplainer(BaseExplainer):
    ...
    """
    def __init__(self, model_to_explain, graphs, features, task, epochs=30,
                 lr=0.003, temp=(5.0, 2.0), reg_coefs=(0.05, 1.0),sample_bias=0,
                 model_eval= None ):
        ...
        if model_eval == None:
            self.model_eval = self.model_to_explain
        else:
    ...
    def prepare(self, indices=None,train=True):
        """
